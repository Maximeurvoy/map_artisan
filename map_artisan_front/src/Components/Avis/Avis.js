...
<h3> Les 10 derniers avis laissés</h3>
        {this.props.dataAvis.slice(this.props.dataAvis.length -10).map((avis, index) => <li key={index}> <h4> {avis.entreprise_nom}</h4><p>{avis.commentaire} <span>note {avis.note}/3</span></p></li>).reverse()}
